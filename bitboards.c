...
void PrintBitBoard (U64 bb){
    ...
    for(rank=RANK_8;rank>=RANK_1;--rank){
        for(file=FILE_A;file<=FILE_H;++file){
            sq = FR2SQ(file,rank); // this gives value starts from 91,92,93.... and ends with 21,21,23,....


            sq64 = SQ64(sq); // this is 120 length array that consist 0 to 63 and others are marked 65
